...
-- ************************************************************
  ...
  MolType = "ND3"											-- a label to keep track of the type of molecule used
  mu = 1.47 * debye										-- permanent dipole moment [Debye]

  starkSlope = 1.44*10^-8 --assumed stark slope (1.2 cm^-1) for a certain low field seeking ND3 state used by MPI. Converted into appropriate units for Simion eV/(V/mm)
...
pa:fill{ function(xg,yg,zg)
 ...
 surface='fractional'
									...
									-- name of the PA containing electrostatic potentials
...
pa2:save('secondStageEfield.pa0')
